...
|---|---|---|---|
| 1 | 2A202600435 | Trịnh Uyên Chi | Lab 2 |
...
**Sản phẩm A**: Perplexity (Free - Anonymous/Default Model).

**Sản phẩm B**: Gemini (Pro - Gemini 3.1 Pro).

---

## Phân chia screenshot

- Sản phẩm A → 2A202600435
- Sản phẩm B → 2A202600435
